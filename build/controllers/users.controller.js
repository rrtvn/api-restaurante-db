...
exports.updateUserById = exports.getUsers = exports.getUserByToken = exports.getUserById = exports.deleteUserById = exports.createUser = void 0;
...
var createUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, rut, name, lastName, email, phone, password, roles, user, foundRoles, savedUser;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, rut = _req$body.rut, name = _req$body.name, lastName = _req$body.lastName, email = _req$body.email, phone = _req$body.phone, password = _req$body.password, roles = _req$body.roles; //FALTARIA tipoUser COMO VARIABLE A INGRESAR
